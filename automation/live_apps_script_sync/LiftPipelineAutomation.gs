...
function buildLiftAuditPrompt_(row, websiteText) {
  ...
  return [
    ...
    '- The draft email should include one specific observation, one practical quick win, a link to https://helloliftstudio.com/, and a short soft offer to send a few more ideas.',
