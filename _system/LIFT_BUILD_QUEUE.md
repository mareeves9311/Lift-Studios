...
**3. Drag-to-reveal microsite template.** Generalize the Morning Fuel before/after microsite (`lift-morning-fuel-audit-693.netlify.app`) into a reusable template: drop in before.jpg / after.jpg / business name → deployable Lift-branded microsite on a helloliftstudio.com path or clean subdomain (never a bare `.netlify.app` link in outreach). This is Lane V's hook factory; 10 minutes per prospect or it's too slow.
