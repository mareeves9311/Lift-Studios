...
**Fact check (Megan, 2026-07-14):** their FACEBOOK is already rebranded — new logo, new name — even though the URL is still /usztics1019. INSTAGRAM is the holdout still carrying Usztics' Flower Shop. The opener reflects this; do not claim Facebook is stale.
**Hook link:** https://helloliftstudio.com/reveal/generations-in-bloom — page built at `site/reveal/generations-in-bloom/`, **NOT YET DEPLOYED**. Deploy before sending or the link 404s.
**GMAIL DRAFT CREATED** (2026-07-14, draftId r-7510003638149931172, helloliftstudio@gmail.com → Generationsinbloom509@outlook.com) — after deploy, sending is one click in Gmail Drafts. Sends are Megan's click, permanently.
**Never contacted before:** verified — zero Gmail hits, not in the Pipeline sheet (row added 2026-07-14).
...
Your new name is already up on Facebook, new logo and all, and it looks right. Instagram is the holdout: the account your site links to still says Usztics' Flower Shop, so anyone who clicks through from your own website meets the old name.
...
I run Lift Studio — I find the specific things costing a local business customers, show the fix, and deliver it done. And when a rebrand needs more than photos, I do that too: websites, SEO, marketing materials.

If the photo side of the rebrand is on your list, want me to send the notes behind these two?
...
## QA record (LIFT_ANTI_AI_OUTPUT_QA_STANDARD.md, all six passes)

1. **Evidence** — rebrand banner: verified on their homepage. Social buttons → old Usztics accounts: verified (facebook.com/usztics1019, instagram.com/uszticsflowershop linked from their own site). Azlynn Beshore/Lead Designer: their Zola listing. "Photos you'd already posted": sources pulled from their public pages during the 7-11 regen session. PASS
2. **Specificity** — rebrand-in-progress + stale social links + two named pieces; unusable for any other business. PASS
3. **Anti-AI language** — no banned words; two em-dashes total; no template shapes. PASS
4. **Commercial** — stale social links = customers losing the new name; restaged set = the monthly product; close = a reply. PASS
5. **Human voice** — reads aloud as one person; no performed enthusiasm. PASS
6. **Tightening** — 150 words body; every sentence carries a fact or the ask. PASS

Lane note: Lane V hook delivered as drag-to-reveal link per LIFT_SYSTEM §2; imagery is the regen batch Megan blessed 2026-07-14 ("both, yes" — studio spray 01 + vase bouquet 06). No attachments, one clean link, helloliftstudio.com domain, per §4.
