...
- **Still open, in order, one at a time:** (1) her yes on the $1,600 bundled rate (PRICING_RATIONALE.md; concede month one to $800, never the recurring); (2) promote to prod and retire the artifact link; (3) send to the manager; (4) JT room photo to disk; (5) Tang's four food tiles short on red (not blocking the send).
